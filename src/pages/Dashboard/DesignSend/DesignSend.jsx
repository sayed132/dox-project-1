...
const DesignSend = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        await axios
            .post("http://103.49.200.66:8080/activities/designsend", formApplication)
            .then(() => {
                console.log(formApplication);
                setTimeout(() => {
    ...
    return (
        <div>
            ...
            <button className="btn" onClick={() => window.my_modal_2.showModal()}>Design Send</button>
