...
const LicenseApprove = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        await axios
            .post("http://103.49.200.66:8080/activities/licenseapprove", formApplication)
            .then(() => {
                console.log(formApplication);
                setTimeout(() => {
    ...
    return (
        <div>
            ...
            <button className="btn" onClick={() => window.my_modal_5.showModal()}>License Approve</button>
